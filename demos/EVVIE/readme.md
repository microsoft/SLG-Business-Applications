...
[![demo video](https://i.imgur.com/5OIfuG4.png)](https://youtu.be/v0GY4xlkOBc)

*If the video above does not work, click [here](https://youtu.be/v0GY4xlkOBc).*
...
1. **Create your own Azure OpenAI instance** - A multi-modal large language model serves as the "brain" of EVVIE. This is the AI model that reviews the photos of damage to vehicles, assess the damages, and then documents its assessment.
    ...
    2. When you go to deploy a model, we recommend you use **GPT-4o** or **GPT-4.1**; both have proved to work well in testing.
